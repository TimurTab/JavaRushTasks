...
public class Solution {
    public static void main(String[] args) {
        ...
        if (cellPhone1.equals(cellPhone2)) {// equals сравнивает сами объекты на равенство, а (==) сравнивает ссылки на объекты.
...
class CellPhone {
    ...
    @Override // внутренняя проверка, что есть метод у родителя с таким же названием.
